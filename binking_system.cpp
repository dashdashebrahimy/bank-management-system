...
class account
{
	private:
		...
		string accnum,word,invent,New_deposit,New_inventory,result = "";
	...
	public:
        ...
        void deposit_money(string accnum,string &inventory )
		{
...
void login()
    {
    	string str,invent,User,inventory;
		...
		else if(answer==2)
		{
			...
			A2.deposit_money(str,inventory);
